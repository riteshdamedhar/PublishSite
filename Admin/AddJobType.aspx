<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_AddJobType, App_Web_lqxqthlg" %>
...
<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadJobType" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="JobTypeId,JobTypeName,date" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadJobType_PageIndexChanged" 
            onrowdatabound="GrdLoadJobType_RowDataBound">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="JobTypeId" HeaderStyle-Width="5%" 
                    HeaderText="JobType Id" />
                <asp:BoundField DataField="JobTypeName" HeaderStyle-Width="30%" 
                    HeaderText="Job Type Name " />
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style25" 
                ...
                <asp:TextBox ID="txtJobType" runat="server" Font-Bold="True" 
