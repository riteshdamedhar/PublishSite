<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_AddInstitute, App_Web_lqxqthlg" %>
...
<p class="style10">
        <strong>Add Institutes</strong></p>
...
<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadInstitute" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="InstituteId,InstituteName,date" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadInstitute_PageIndexChanged" 
            onrowdatabound="GrdLoadInstitute_RowDataBound">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="InstituteId" HeaderStyle-Width="5%" 
                    HeaderText="Institute Id" />
                <asp:BoundField DataField="InstituteName" HeaderStyle-Width="30%" 
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style25" 
                ...
                <asp:TextBox ID="txtInstitute" runat="server" Font-Bold="True" 
