<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_AddCoures, App_Web_lqxqthlg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="style9">
        <strong>Add Management Job</strong></p>



<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadMgtJob" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="MgtJobId,MgtJobHeading,MgtJobDesc,MgtJobDate" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadMgtJob_PageIndexChanged" 
            onrowcommand="GrdLoadMgtJob_RowCommand">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="MgtJobId" HeaderStyle-Width="5%" 
                    HeaderText="job Id" />
                <asp:BoundField DataField="MgtJobHeading" HeaderStyle-Width="30%" 
                    HeaderText="Job Heading" />
                <asp:BoundField DataField="MgtJobDesc" HeaderStyle-Width="50%" 
                    HeaderText="Description" Visible="true" />
                
                <asp:BoundField DataField="MgtJobDate" HeaderStyle-Width="10%" 
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style11" 
                ...
                Management Job Heading : :</td>
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:TextBox ID="txtMgtHead" runat="server" Font-Bold="True" 
        ...
        <tr>
            ...
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:TextBox ID="txtMgtDesc" runat="server" Font-Bold="True" 
