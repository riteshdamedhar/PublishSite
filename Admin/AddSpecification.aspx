<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_AddSpecification, App_Web_lqxqthlg" %>
...
<p class="style10">
        <strong>Add Specification</strong></p>
...
<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadSpecification" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="SpecificationId,SpecificationName,QualificationId,date" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadSpecification_PageIndexChanged" 
            onrowdatabound="GrdLoadSpecification_RowDataBound">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="SpecificationId" HeaderStyle-Width="5%" 
                    HeaderText="Specification Id" />
                <asp:BoundField DataField="SpecificationName" HeaderStyle-Width="30%" 
                    HeaderText="Specification Name " />
                <asp:BoundField DataField="QualificationId" HeaderStyle-Width="30%" 
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style11" 
                ...
                Specification name&nbsp; : :</td>
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:TextBox ID="txtSpecification" runat="server" Font-Bold="True" 
        ...
        <tr>
            ...
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:DropDownList ID="ddlQualification" runat="server" Width="250px">
                </asp:DropDownList>
            </td>
            <td>
                &nbsp;</td>
