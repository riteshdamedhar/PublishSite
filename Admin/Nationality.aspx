<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_Nationality, App_Web_lqxqthlg" %>
...
<p class="style10">
        <strong>Add Nationality</strong></p>
...
<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadNationality" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="NationalityId,Nationality,date" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadNationality_PageIndexChanged" 
            onrowdatabound="GrdLoadNationality_RowDataBound">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="NationalityId" HeaderStyle-Width="5%" 
                    HeaderText="Nationality Id" />
                <asp:BoundField DataField="Nationality" HeaderStyle-Width="30%" 
                    HeaderText="Nationality" />
               
                
                <asp:BoundField DataField="date" HeaderStyle-Width="10%" 
                    HeaderText="Nationality Date" Visible="true" />
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style25" 
                ...
                <asp:TextBox ID="txtNationality" runat="server" Font-Bold="True" 
