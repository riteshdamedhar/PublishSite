<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_AddClassNews, App_Web_lqxqthlg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="style10">
        <strong>Add Government Job</strong></p>
...
<br />
    <asp:Panel ID="PanelShow" runat="server">
        <asp:GridView ID="GrdLoadGovJob" runat="server" AllowPaging="true" 
            AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="Solid" 
            BorderWidth="1px" DataKeyNames="GovJobId, GovJobHeading, GovJobDesc,GovJobDate" 
            EmptyDataText="No files found!" Font-Names="Verdana" PageSize="5" 
            Width="100%" onpageindexchanged="GrdLoadGovJob_PageIndexChanged" 
            onrowcommand="GrdLoadGovJob_RowCommand">
            ...
            <Columns>
                <asp:BoundField DataField="rowid" HeaderStyle-Width="5%" 
                    HeaderText="Sr. No." />
                <asp:BoundField DataField="GovJobId" HeaderStyle-Width="5%" 
                    HeaderText="Job Id" />
                <asp:BoundField DataField="GovJobHeading" HeaderStyle-Width="30%" 
                    HeaderText="Job Heading" />
                <asp:BoundField DataField="GovJobDesc" HeaderStyle-Width="50%" 
                    HeaderText="Description" Visible="true" />
                
                <asp:BoundField DataField="GovJobDate" HeaderStyle-Width="10%" 
                    HeaderText="Job Date" Visible="true" />
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style11" 
                ...
                Govrenment Job Heading : :</td>
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:TextBox ID="txtGovJobHead" runat="server" Font-Bold="True" 
        ...
        <tr>
            ...
            <td class="style11" 
                ...
                style="border-left-style: groove; border-left-width: medium; text-align: right;">
                Government Job Description : : </td>
            <td class="style25" 
                style="border-right-style: groove; border-right-width: medium">
                <asp:TextBox ID="txtGovJobDesc" runat="server" Font-Bold="True" 
