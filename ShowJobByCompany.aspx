<%@ page title="" language="C#" masterpagefile="~/MasterPage2.master" autoeventwireup="true" inherits="ShowJobByCompany, App_Web_3kyftmgl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        <tr>
            <td class="style10">
                <strong><span class="style11">Job By </span>
                </strong>
            </td>
        </tr>
        <tr>
