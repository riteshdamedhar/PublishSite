<%@ page title="" language="C#" masterpagefile="~/Student/StudentMaster.master" autoeventwireup="true" inherits="Student_AppliedJobs, App_Web_2sqaqgoh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style1">
        <tr>
            <td class="style10">
                <strong>Job Status that you Applied</strong></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            BorderWidth="1px" DataKeyNames="JobTitle,CompanyName,Status,PostJobId,CompanyId,StudentId" 
